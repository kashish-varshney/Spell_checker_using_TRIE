//Spell checker using trie data structure ...if the word is present in the trie it will print the word , else it will print all the related suggestions of the word 
//Additionally we can insert, delete and update the word from the trie
#include<bits/stdc++.h> 
using namespace std; 
